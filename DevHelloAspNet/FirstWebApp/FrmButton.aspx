...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:TextBox ID="TxtNum" runat="server" /><br />
            <asp:Button ID="BtnInc" runat="server" Text="증가" OnClick="BtnInc_Click" /><br />
            <asp:Button ID="ButDec" runat="server" Text="감소" Onclick="ButDec_Click" /><br />
